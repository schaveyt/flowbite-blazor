        ...
        private IEnumerable<string> GetColorClasses()
        {
            return Style switch
            {
                ButtonStyle.Default => Color switch
                {
                    ...
                    ButtonColor.Alternative => new[] { "text-gray-900", "bg-white", "border", "border-gray-200", "hover:bg-gray-100", "focus:ring-4", "focus:ring-gray-100", "dark:bg-gray-800", "dark:text-white", "dark:border-gray-600", "dark:hover:bg-gray-700", "dark:focus:ring-gray-700" },
                ...
                ButtonStyle.Outline => Color switch
                {
                    ...
                    ButtonColor.Alternative => new[] { "text-gray-900", "border", "border-gray-800", "hover:bg-gray-900", "hover:text-white", "focus:ring-4", "focus:ring-gray-300", "dark:border-gray-600", "dark:text-gray-400", "dark:hover:text-white", "dark:hover:bg-gray-600", "dark:focus:ring-gray-700" },
